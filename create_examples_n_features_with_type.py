...
class DropExample(object):
    def __init__(self,
        ...
        self.intermed_values = intermed_values
    def __str__(self):
    ...
    def __repr__(self):
        ...
        if self.intermed_values:
            s += ", \nintermed_values: {}".format(self.intermed_values)
        if self.answer_type:
        ...
        if self.type_text:
            s += ", \ntype_text: {}".format(self.type_text)
...
class DropReader(object):
    ...
    def _read(self, file_path: str):
        ...
        for passage_id, passage_info in tqdm(dataset.items()): 
            ...
            type_text = passage_info["type"]
            intermed_values = passage_info["intermed_values"]
            for question_answer in passage_info["qa_pairs"]:
                ...
                example = self.text_to_example(question_text, passage_text, passage_id, question_id, type_text,intermed_values,answer_annotations)
    ...
    def text_to_example(self,  # type: ignore
       ...
       # Tokenize the answer text in order to find the matched span based on token
        ...
        return DropExample(
            ...
            type_text=type_text,
            intermed_values=intermed_values)
    @staticmethod
